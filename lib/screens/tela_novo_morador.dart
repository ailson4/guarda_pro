          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                // Define o início da cobrança para o dia 1 do mês que vem
                final inicioCobranca = DateTime(agora.year, agora.month + 1, 1);
                ...
                await FirebaseFirestore.instance.collection('moradores').add({
                  ...
                  'guarda_id': uid,
                  'data_inicio_cobranca': inicioCobranca,
                });
                if (context.mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
